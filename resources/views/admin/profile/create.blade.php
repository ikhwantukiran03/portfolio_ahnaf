...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Create My Profile</h2>
        </div>

        <form action="{{ route('admin.profile.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Tell visitors about yourself, your experience, and skills...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
