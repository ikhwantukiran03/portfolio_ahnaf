...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Create New Profile</h2>
        </div>

        <form action="{{ route('profiles.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg">
            @csrf
