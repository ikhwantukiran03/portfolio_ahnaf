...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add New Social Contact</h1>
        ...
        <form action="{{ route('admin.social-contacts.store') }}" 
              method="POST" 
            ...
            <div class="space-y-6">
                ...
                <div id="custom-type-field" style="display: none;">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                              placeholder="Additional information about this contact">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    typeSelect.addEventListener('change', function() {
        ...
        if (selectedType && contactTypes[selectedType]) {
            ...
            // Reset to defaults
            labelInput.placeholder = 'e.g., Work Email, Personal LinkedIn';
    ...
    // Trigger change event if type is pre-selected (e.g., from old input)
    if (typeSelect.value) {
